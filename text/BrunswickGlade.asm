_BrunswickGladeSign::
	text "CLARO de BRUNSWICK"
	line "El exuberante..."
	
	para "El cartel ha sido"
	line "derribado. Es"
	cont "imposible leerlo"
	done
...
_BrunswickGladeAfterBattleText1::
	text "¡PUEBLO PALETA es" ; Later in the series, this lore is retroactively added. Here, we're using it for worldbuilding.
	line "conocido por"
	cont "sus fuertes"
	cont "entrenadores!"
	
	para "¡Una vez, un RATTATA" ; Masters lore
	line "se coló en mi"
	cont "cocina y ahora"
	cont "están por todas"
	cont "partes!"
	done
...
_BrunswickGladeAfterBattleText2::
	text "He cometido dema-"
	line "siados errores en"
	cont "mi vida."
	
	para "Pero mientras"
	line "aprenda y lo haga"
	cont "mejor, es lo que"
	cont "realmente importa"
	done

_BrunswickGladeBattleText3:: ; Ariana - uses stad2 quotes
	text "Esa mirada pene-"
	line "trante..."
	
	para "Parece bastante"
	line "competente."
	done

_BrunswickGladeEndBattleText3::
	text "¡No puedo mirarlo"
	line "a la cara"
